...
// from this class.
//********************************************************************
const list<char>& LineEditor::getList() const
{
	return textList;
}
...
// from this class.
//********************************************************************
const list<char>::iterator& LineEditor::getIterator() const
{
	return cursor;
}
//********************************************************************
...
{
	textList.insert(cursor,s.begin(),s.end());
}
...
{	
	...
	for (list<char>::const_iterator iter = le.getList().begin(); 
